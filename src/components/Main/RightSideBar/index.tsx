...
export const RightSideBar: React.FC = () => {
    ...
    const userName: string = (user && user.given_name) ? JSON.stringify(user.given_name).replace(/"/g, '') : '';
        ...
        <div className={styles.menu}>
            ...
            <div className={styles.menu__movies}>
                <div className={styles.menu__episode}>
                    ...
                    <div>
                        <p>WandaVision</p>
                        <p className={styles.menu__episode__text}>
                            1 Episode left
                        </p>
            ...
            <div className={styles.menu__movies__top}>
                <div>
                    ...
                    <div className={styles.menu__top__rated}>
                        <p>320 Ep</p>
                        <p className={styles.menu__top__text}>
                            Horror, Fantasy
                        </p>
                    </div>
                </div>
