...
export const MainSlider: React.FC = () => {
    ...
    return (
        <div className={styles.slider}>
            <div className={styles.slider__container}>
                <div className={styles.slider__scroll}>
                    ...
                    <div className={styles.slider__arrow__block}>
                        <button className={styles.slider__left__arrow}>
                            <img src={leftArrow} alt="leftArrow" />
                        </button>
                        <button className={styles.slider__right__arrow}>
                            <img src={rightArrow} alt="rightArrow" />
                        </button>
                    </div>
                    <div className={styles.slider__watch__btn}>
                        <button className={styles.slider__wathclist}>
                            + Watchlist
                        </button>
                        <button className={styles.slider__watch}>
                            Watch Now
                        </button>
                    </div>
                </div>
            ...
            <div>
                <MainCard newValueOfListArray={newValueOfListArray} />
            </div>
        </div>
    );
};
